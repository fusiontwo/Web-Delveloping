...
// 2) 주석(comment) : 설명문을 작성하기 위한 구문, 프로그램 실행에 영향을 미치지 않는다.
...
public class PrintEx01 {
	...
	public static void main(String[] args) {  // main 메서드 {} 안에서 프로그래밍을 한다.
		
		// tab으로 들여쓰기 한 이후에 코드를 작성한다.
		
		// System.out.println(데이터); : 데이터를 화면에 출력한 뒤에 줄을 바꾼다(개행).
		
		System.out.println("============");
		System.out.println(" 메뉴 선택 ");
		System.out.println("============");
		
		// 출력 데이터가 없으면 줄바꿈 기능만 적용하여 한줄을 띄운다.
		System.out.println();
		System.out.println();
		System.out.println();
		...
		// System.out.print(데이터); : 데이터를 화면에 출력한 뒤에 줄을 바꾸지 않는다.
