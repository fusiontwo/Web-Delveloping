	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if		(choice == 1) {
				...
				average = totalScore / studentCnt;
				System.out.println("총 학생 수 : " + studentCnt);
				...
				System.out.println("1등 학생의 학번 : " + mega.arHakbun[idx]);
				System.out.println("1등 학생의 점수 : " + mega.arScore[idx]);
			}
			else if (choice == 3) {
				int minScore = 101;
				int idx = 0;
				...
				System.out.print("점수를 알고 싶은 학생의 학번을 입력하세요 : ");
